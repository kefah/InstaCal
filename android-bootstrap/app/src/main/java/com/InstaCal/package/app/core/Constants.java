...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.InstaCal.package.app";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "InstaCal";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.InstaCal.package.app.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.InstaCal.package.app.";
